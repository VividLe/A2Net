...
def train(cfg, train_loader, model, optimizer):
    ...
    for feat_spa, feat_tem, boxes, label, action_num, cls_label, reg_label, cate_label in train_loader:
        ...
        # complete loss
        loss = cls_loss_ab + cfg.TRAIN.P_CONF_AB * overlap_loss_ab + cfg.TRAIN.P_LOC_AB * loc_loss_ab
        ...
        overlap_loss_ab_record = overlap_loss_ab_record + overlap_loss_ab.item()
    ...
    overlap_loss_ab_record_avg = overlap_loss_ab_record / len(train_loader)
    loc_loss_ab_record_avg = loc_loss_ab_record / len(train_loader)

    return loss_avg, cls_loss_ab_record_avg, overlap_loss_ab_record_avg, loc_loss_ab_record_avg
